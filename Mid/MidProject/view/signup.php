...
<body>
  ...
  <form action="/Find_Your_Job/controller/action_signup.php" method="POST">
  <div>
    <h2>Sign Up</h2>
    ...
    <div>
      ...
      <button type="button" onClick="document.location.href='/Find_Your_Job/view/login.php'">Login</button>
